...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\kitlogo.jpg" alt="" class="NavLogo" onclick="rtohome()">
    ...
    <ul class="NavMenu ">
      ...
      <li class="NavItem"><a id="linkcolor4" class="NavLinks" href="MessBooking.php">Mess Booking</a></li>
...
<div class="HeroContent">
  ...
  <p class="HeroP">KIT College KOLHAPUR</p>
...
<div class="FooterWrap">
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">KIT KOLHAPUR © 2023</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/kitcoekolhapur/" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/officialkitcoek" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/kitcoek.official/" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/@OfficialKITCOEK" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
